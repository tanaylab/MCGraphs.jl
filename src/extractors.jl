...
@computation Contract(;
    ...
    data = [
        ...
        ("gene", "is_lateral") => (OptionalInput, Bool, "A mask of genes of behaviors we want to ignore."),
    ...
    for gene_index in 1:n_genes
        ...
        elseif is_correlated_of_x_sphere_of_genes[gene_index]
            if is_correlated_of_y_sphere_of_genes[gene_index]
        ...
        points_hovers[point_index] = join(  # NOJET
            [
                ...
                "- UMIs: $(x_total_UMIs_of_genes[gene_index]) / $(x_total_UMIs_of_metacell_of_genes[gene_index])",
                y_label,
                ...
                "- UMIs: $(y_total_UMIs_of_genes[gene_index]) / $(y_total_UMIs_of_metacell_of_genes[gene_index])",
            ],
            "<br>",
        )
